...
import com.txt.readerlibrary.adapter.FileAdapter;
 ...
 */
public class FileActivity extends BaseLibrayActivity{
    public static final int EXTERNAL_STORAGE_REQ_CODE = 10;
//    @BindView(R.id.toolbar)
    Toolbar toolbar;
    AppBarLayout appbar;
    TextView tvFileTitle;
    ImageButton btnFileReturn;
    LinearLayout llFile;
    Button btnChooseAll;
    Button btnDelete;
    Button btnAddFile;
    ...
    private  void initView(){
        ...
        tvFileTitle=(TextView) findViewById(R.id.tv_file_title);
         btnFileReturn=(ImageButton) findViewById(R.id.btn_file_return);
        llFile=(LinearLayout) findViewById(R.id.ll_file);
        btnChooseAll=(Button) findViewById(R.id.btn_choose_all);
        btnDelete=(Button)findViewById(R.id.btn_delete);
        btnAddFile=(Button)findViewById(R.id.btn_add_file);
        lvFileDrawer=(ListView)findViewById(R.id.lv_file_drawer);
