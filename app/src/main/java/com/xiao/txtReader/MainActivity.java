...
import com.xiao.txtReader.adapter.ShelfAdapter;
import com.xiao.txtReader.base.BaseActivity;
import com.txt.readerlibrary.FileChooserActivity;
import com.zhy.http.okhttp.OkHttpUtils;
import com.zhy.http.okhttp.callback.StringCallback;
import com.txt.readerlibrary.animation.ContentScaleAnimation;
import com.txt.readerlibrary.animation.Rotate3DAnimation;
import com.txt.readerlibrary.db.BookList;
import com.txt.readerlibrary.view.DragGridView;
        ...
        bookShelf.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (bookLists.size() > position) {
                    ...
                    adapter.setItemToFirst(itemPosition); //当前item打开后移动到第一位
